    ...
    <div class="row g-3">
        ...
        <div class="col-lg-9">
            ...
            <div class="card-box">
                ...
                $sid = (int)$st['id'];
                $photo = $photoMap[$sid] ?? '';
                $photoHtml = $photo ? "<img class='thumb' src='".htmlspecialchars($photo)."' alt='photo'>" : "<span class='text-muted'>—</span>";
              ?>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <div class="d-grid gap-1">
                                        ...
                                        <a class="btn btn-sm btn-outline-dark"
                                            href="student_file.php?student_id=<?php echo $sid; ?>" target="_blank">
                                            Open Student File
                                        </a>
                                    </div>
                                </td>
